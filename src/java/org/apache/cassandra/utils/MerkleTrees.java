...
public class MerkleTrees implements Iterable<Map.Entry<Range<Token>, MerkleTree>> {
  ...
  public class TreeRangeIterator extends AbstractIterator<MerkleTree.TreeRange>
      implements Iterable<MerkleTree.TreeRange>, PeekingIterator<MerkleTree.TreeRange> {
